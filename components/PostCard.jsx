...
const PostCard = ({ post }) => {
    console.log(post)
    return (
        <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-7">
            ...
            <div className="block lg:flex text-center items-center justify-center mb-7 w-full">
                <div className="flex items-cetner justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-7">
                    <img
            ...
            <p className="text-center text-lg font-normal px-4 lg:px-20 mb-7">{post.excerpt}</p>
            <div className="text-center">
                <Link href={`/post/${post.slug}`}>
                    <span className="tranisiton duration-250 transform hover:translate-y-1 inline-block bg-green-500 text-lg font-medium rounded-full text-white px-7 py-3 cursor-pointer">
                        Continue Reading
                    </span>
                </Link>
            </div>
